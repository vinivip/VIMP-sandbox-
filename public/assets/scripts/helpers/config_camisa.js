...
var camisa_corpo_regata_feminina = 89
...
var arrMangaNenhuma = [camisa_manga_nenhuma,camisa_corpo_machao,camisa_corpo_normal,camisa_corpo_baby_look,camisa_corpo_recorte_de_tecido,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_colete,camisa_corpo_avental,];
...
var camisa_pescoco_gola_decote_nadador = 91;
...
var arrPescocoSemAcabamento = [camisa_pescoco_sem_acabamento,camisa_corpo_baby_look,camisa_corpo_machao,camisa_corpo_normal,camisa_corpo_raglan,camisa_corpo_raglan_bl,camisa_corpo_recorte_de_tecido,camisa_corpo_regata,camisa_corpo_colete];
...
var arrPescocoGolaDecoteNadador = [camisa_pescoco_gola_decote_nadador,camisa_corpo_regata_feminina];
...
arrRelacionamentosPartes.push(arrPescocoGolaDecoteNadador);
...
var arrCamisaBolsoFrenteNenhum = [camisa_bolso_frente_nenhum,camisa_corpo_avental,camisa_corpo_polo,camisa_corpo_colete,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_recorte_de_tecido,camisa_corpo_raglan_bl,camisa_corpo_raglan,camisa_corpo_normal,camisa_corpo_machao,camisa_corpo_baby_look];
var arrCamisaBolsoFrenteInvisivel = [camisa_bolso_frente_invisivel,camisa_corpo_avental,camisa_corpo_polo,camisa_corpo_colete,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_recorte_de_tecido,camisa_corpo_raglan_bl,camisa_corpo_raglan,camisa_corpo_normal,camisa_corpo_machao,camisa_corpo_baby_look];
var arrCamisaBolsoFrenteVisivel = [camisa_bolso_frente_visivel,camisa_corpo_avental,camisa_corpo_polo,camisa_corpo_colete,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_recorte_de_tecido,camisa_corpo_raglan_bl,camisa_corpo_raglan,camisa_corpo_normal,camisa_corpo_machao,camisa_corpo_baby_look];
...
var arrCamisaBolsoCostasNenhum = [camisa_bolso_costas_nenhum,camisa_corpo_avental,camisa_corpo_polo,camisa_corpo_colete,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_recorte_de_tecido,camisa_corpo_raglan_bl,camisa_corpo_raglan,camisa_corpo_normal,camisa_corpo_machao,camisa_corpo_baby_look];
var arrCamisaBolsoCostasComDivisao = [camisa_bolso_costas_com_divisao,camisa_corpo_polo,camisa_corpo_colete,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_recorte_de_tecido,camisa_corpo_raglan_bl,camisa_corpo_raglan,camisa_corpo_normal,camisa_corpo_machao,camisa_corpo_baby_look];
var arrCamisaBolsoCostasSemDivisao = [camisa_bolso_costas_sem_divisao,camisa_corpo_polo,camisa_corpo_colete,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_recorte_de_tecido,camisa_corpo_raglan_bl,camisa_corpo_raglan,camisa_corpo_normal,camisa_corpo_machao,camisa_corpo_baby_look];
...
var camisa_cava_regata_feminina = 90
...
var arrCamisaCavaRegataFeminina = [camisa_cava_regata_feminina, camisa_corpo_regata_feminina]
...
arrRelacionamentosPartes.push(arrCamisaCavaRegataFeminina)


//EXIBI��O APENAS QDO A PARTE ESTIVER SELECIONADA, POIS � UMA EXIBI��O NAS COSTAS
...
var arrAcabamentoCamisaCorpoAbanhado = [acabamento_camisa_corpo_abanhado,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_baby_look,camisa_corpo_machao,camisa_corpo_normal,camisa_corpo_raglan,camisa_corpo_raglan_bl,camisa_corpo_colete,camisa_corpo_polo,camisa_corpo_recorte_de_tecido,camisa_corpo_avental];
var arrAcabamentoCamisaCorpoCos = [acabamento_camisa_corpo_cos,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_baby_look,camisa_corpo_machao,camisa_corpo_normal,camisa_corpo_raglan,camisa_corpo_raglan_bl,camisa_corpo_colete,camisa_corpo_polo,camisa_corpo_recorte_de_tecido];
var arrAcabamentoCamisaCorpoElastico = [acabamento_camisa_corpo_elastico,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_baby_look,camisa_corpo_machao,camisa_corpo_normal,camisa_corpo_raglan,camisa_corpo_raglan_bl,camisa_corpo_colete,camisa_corpo_polo,camisa_corpo_recorte_de_tecido];
var arrAcabamentoCamisaCorpoSemAcabamento = [acabamento_camisa_corpo_sem_acabamento,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_baby_look,camisa_corpo_machao,camisa_corpo_normal,camisa_corpo_raglan,camisa_corpo_raglan_bl,camisa_corpo_colete,camisa_corpo_polo,camisa_corpo_recorte_de_tecido];
var arrAcabamentoCamisaCorpoVies = [acabamento_camisa_corpo_vies,camisa_corpo_regata,camisa_corpo_regata_feminina,camisa_corpo_baby_look,camisa_corpo_machao,camisa_corpo_normal,camisa_corpo_raglan,camisa_corpo_raglan_bl,camisa_corpo_colete,camisa_corpo_polo,camisa_corpo_recorte_de_tecido,camisa_corpo_avental];
...
var acabamento_camisa_gola_vies = 113;//
var acabamento_camisa_gola_rebatido = 114;//
...
// var arrAcabamentoCamisaGolaNenhum = [acabamento_camisa_gola_nenhum,camisa_pescoco_abanhado,camisa_pescoco_sem_acabamento,camisa_pescoco_nenhum];
var arrAcabamentoCamisaGolaNenhum = [acabamento_camisa_gola_nenhum,camisa_pescoco_sem_acabamento,camisa_pescoco_nenhum];
...
var arrAcabamentoCamisaGolaVies = [acabamento_camisa_gola_vies,camisa_pescoco_sem_acabamento, camisa_pescoco_gola_decote_nadador]
var arrAcabamentoCamisaGolaRebatido = [acabamento_camisa_gola_rebatido, camisa_pescoco_sem_acabamento, camisa_pescoco_gola_decote_nadador]
...
arrRelacionamentosAcabamentos.push(arrAcabamentoCamisaGolaVies)
arrRelacionamentosAcabamentos.push(arrAcabamentoCamisaGolaRebatido)
...
var arrAcabamentoCamisaCavaNenhum = [acabamento_camisa_cava_nenhum,camisa_cava_nenhuma,camisa_cava_machao,camisa_cava_regata,camisa_cava_regata_feminina,camisa_cava_normal,camisa_cava_colete];
var arrAcabamentoCamisaCavaRebatido = [acabamento_camisa_cava_rebatido,camisa_cava_machao,camisa_cava_regata,camisa_cava_regata_feminina,camisa_cava_normal,camisa_cava_colete];
var arrAcabamentoCamisaCavaPunhoChapadoRibana = [acabamento_camisa_cava_punho_chapado_ribana,camisa_cava_machao,camisa_cava_regata,camisa_cava_regata_feminina,camisa_cava_normal,camisa_cava_colete];
var arrAcabamentoCamisaCavaPunhoRibana = [acabamento_camisa_cava_punho_ribana,camisa_cava_machao,camisa_cava_regata,camisa_cava_regata_feminina,camisa_cava_normal,camisa_cava_colete];
var arrAcabamentoCamisaCavaVies = [acabamento_camisa_cava_vies,camisa_cava_machao,camisa_cava_regata,camisa_cava_regata_feminina,camisa_cava_normal,camisa_cava_colete];
...
//arrDefault est� declarado em lib_hierarquia
